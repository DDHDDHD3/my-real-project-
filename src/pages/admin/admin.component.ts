...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gray-100 flex flex-col md:flex-row">
      <!-- Admin Sidebar -->
      <aside class="w-full md:w-72 bg-gray-900 md:min-h-screen p-8 space-y-10 no-print shadow-2xl">
        ...
        <nav class="space-y-3">
          <a routerLink="general" routerLinkActive="bg-blue-600 text-white shadow-lg shadow-blue-500/20" class="flex items-center gap-4 p-4 rounded-2xl text-gray-400 hover:bg-gray-800 transition-all font-semibold">
          ...
          <a routerLink="projects" routerLinkActive="bg-blue-600 text-white shadow-lg shadow-blue-500/20" class="flex items-center gap-4 p-4 rounded-2xl text-gray-400 hover:bg-gray-800 transition-all font-semibold">
          ...
          <a routerLink="skills" routerLinkActive="bg-blue-600 text-white shadow-lg shadow-blue-500/20" class="flex items-center gap-4 p-4 rounded-2xl text-gray-400 hover:bg-gray-800 transition-all font-semibold">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
            Manage Skills
          </a>
          <a routerLink="messages" routerLinkActive="bg-blue-600 text-white shadow-lg shadow-blue-500/20" class="flex items-center gap-4 p-4 rounded-2xl text-gray-400 hover:bg-gray-800 transition-all font-semibold">
          ...
          <div class="pt-8 space-y-4">
            ...
            <div class="flex flex-col gap-3">
              <a routerLink="/" class="flex items-center gap-4 p-4 rounded-2xl text-blue-400 hover:bg-blue-500/10 transition-all font-bold border-2 border-blue-500/20">
      ...
      <main class="flex-1 p-6 md:p-10 lg:p-14 overflow-y-auto bg-gray-50/50">
